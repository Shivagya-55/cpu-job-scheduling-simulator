/**
 * Priority Scheduling CPU Algorithm (Non-Preemptive)
 ...
 */
export function solvePriority(processes) {
  ...
  while (completedCount < totalProcesses) {
    ...
    // Select process with highest priority (lowest numerical priority value)
    // Tie-breakers: earliest arrivalTime, then originalIndex
    available.sort((a, b) => {
